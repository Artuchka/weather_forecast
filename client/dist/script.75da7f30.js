...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/date-fns/esm/_lib/toInteger/index.js":[function(require,module,exports) {
"use strict";
...
var dayilySection = document.querySelector("[data-day-section]");
var dayCardTemplate = document.querySelector("#day-card-template");

function renderDailyWeather(daily) {
  dayilySection.innerHTML = "";
  daily.forEach(function (day) {
    var newDay = dayCardTemplate.content.cloneNode(true);
    setValue("temp", day.temp, {
      parent: newDay,
      extra: ""
    });
...
var hourlySection = document.querySelector("[data-hour-section]");
var hourRowTemplate = document.querySelector("#hour-row-template");

function renderHourlyWeather(hourly) {
  hourlySection.innerHTML = "";
  hourly.forEach(function (hour) {
    var newHour = hourRowTemplate.content.cloneNode(true);
    setValue("temp", hour.temp, {
      parent: newHour,
      extra: ""
    });
    setValue("fl", hour.feelsLike, {
      parent: newHour,
      extra: ""
    });
...
function setValue(selector, value) {
  var _ref3 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
      ...
      extra = _ref3$extra === void 0 ? "-current" : _ref3$extra;

  parent.querySelector("[data".concat(extra, "-").concat(selector, "]")).textContent = value;
}

function formatDay(timestamp) {
  return (0, _dateFns.format)(new Date(timestamp), "eeee");
}

function formatHour(timestamp) {
  return (0, _dateFns.format)(new Date(timestamp), "H");
}
...
function getIconURL(icon) {
  ...
  var size = large ? "@2x" : "";
  return "http://openweathermap.org/img/wn/".concat(icon).concat(size, ".png");
}
